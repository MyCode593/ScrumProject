...
public class DistanciaCalculo {
    ...
    public Pois obtenerDistanciaMasCorta(double latitudUbicacion, double longitudUbicacion)
	{
    	ArrayList<Pois> LlenarPoisArrayX = new ArrayList<Pois>() ;
